...
if __name__ == "__main__":
    ...
    path = "./models/MATD3"
    matd3 = MATD3.load(path+"/MATD3_wohpo_trained_agent_fog5_N9.pt", device)
    ...
    with open(os.path.join(path, 'eval_wohpo_score_N_9.csv'), 'w', newline='') as file:
                writer = csv.writer(file)
                for i in range(len(rewards)):
                    writer.writerow([i, rewards[i], exection_time[i], energy[i], pay[i]])
    with open(os.path.join(path, 'eval_wohpo_fog_N_9.csv'), 'w', newline='') as file:
                writer = csv.writer(file)
    ...
    plt.legend()
    plt.savefig(os.path.join(gif_path, 'individual_agent_rewards_n9.png'))
    plt.show()
    ...
    #plt.grid()
    #plt.xticks(range(1, episodes+1))
    plt.savefig(os.path.join(gif_path, 'total_episodic_rewards_n9.png'))
    plt.show()
    plt.figure()
    ...
    #plt.grid()
    #plt.xticks(range(1, episodes+1))
    plt.savefig(os.path.join(gif_path, 'total_exection_time_n9.png'))
    plt.show()
    plt.figure()
    ...
    #plt.grid()
    #plt.xticks(range(1, episodes+1))
    plt.savefig(os.path.join(gif_path, 'total_energy_n9.png'))
    plt.show()
    plt.figure()
    ...
    #plt.grid()
    #plt.xticks(range(1, episodes+1))
    plt.savefig(os.path.join(gif_path, 'total_cost_n9.png'))
    plt.show() 